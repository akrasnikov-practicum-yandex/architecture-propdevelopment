...
Доработайте диаграмму контейнеров PropDevelopment(https://code.s3.yandex.net/b2b/grade/PropDevelopment_%D0%A14_model.drawio.xml?etag=816951795d3f29599e82b23752306a2e) . Отразите на ней изменения, которые вы предлагаете сделать в ландшафте систем кампании в связи с внедрением новых бизнес-функций.
